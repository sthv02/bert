    ...
    for i in range(epoch):
        ...
        if i % val_epoch == 0:
            ...
            print('[%03d/%03d] %2.2f sec(s) TrainAcc : %3.6f TrainLoss : %3.6f   valAcc: %3.6f valLoss: %3.6f  ' % \
                  (i+1, epoch, time.time()-start_time, plt_train_acc[-1], plt_train_loss[-1], plt_val_acc[-1], plt_val_loss[-1])
                  )
            if i % 50 == 0:
            ...
            print('[%03d/%03d] %2.2f sec(s) TrainAcc : %3.6f TrainLoss : %3.6f   ' % \
                  (i+1, epoch, time.time()-start_time, plt_train_acc[-1], plt_train_loss[-1])
                  )
